...
void RegisterPlugins(flutter::PluginRegistry* registry) {
  ...
  RustLibNipaplayPluginCApiRegisterWithRegistrar(
      registry->GetRegistrarForPlugin("RustLibNipaplayPluginCApi"));
