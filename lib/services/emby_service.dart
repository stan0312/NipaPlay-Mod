  ...
  Future<List<EmbyMediaItem>> getSwipeItems({
    ...
    try {
      ...
      if (playlistId != null) {
        ...
        if (favoritesOnly) {
          path =
              '/emby/Users/$_userId/Items?Recursive=true&Filters=IsFavorite&IncludeItemTypes=Movie,Episode,Video,Series&Fields=Overview,Genres,CommunityRating,ProductionYear,DateCreated,Size,ParentId,Path,UserData$sortQuery';
        } else {
          path =
