...
class _RenderInteractiveIndicator extends RenderProxyBox {
  ...
  // Reusable layer handles — avoid allocation on every spring/route frame.
  ...
  void _updateShaderUniforms(Size size, Offset physicalOrigin,
    ...
    // 16: uCornerRadius (float) - Logical. Concrete type matching is stable
    // in obfuscated AOT builds; runtime class names are not.
    final cornerRadius = resolveLiquidShapeCornerRadius(_shape, size);
